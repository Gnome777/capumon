...
Route2HS:
	db ROUTE_2, ROUTE2_MOON_STONE, HIDE
	db ROUTE_2, ROUTE2_HP_UP,      HIDE
Route4HS:
	db ROUTE_4, ROUTE4_TM_WHIRLWIND, HIDE
Route9HS:
	db ROUTE_9, ROUTE9_TM_TELEPORT, HIDE
Route12HS:
	db ROUTE_12, ROUTE12_SNORLAX,    SHOW
	db ROUTE_12, ROUTE12_TM_PAY_DAY, HIDE
	db ROUTE_12, ROUTE12_IRON,       HIDE
Route15HS:
	db ROUTE_15, ROUTE15_TM_RAGE, HIDE
Route16HS:
...
Route24HS:
	...
	db ROUTE_24, ROUTE24_TM_THUNDER_WAVE, HIDE
Route25HS:
	db ROUTE_25, ROUTE25_TM_SEISMIC_TOSS, HIDE
BluesHouseHS:
...
ViridianGymHS:
	...
	db VIRIDIAN_GYM, VIRIDIANGYM_REVIVE,   HIDE
Museum1FHS:
...
CeruleanCaveHS:
	...
	db CERULEAN_CAVE_1F, CERULEANCAVE1F_NUGGET,       HIDE
PokemonTower2FHS:
...
PokemonTower5FHS:
	db POKEMON_TOWER_5F, POKEMONTOWER5F_NUGGET, HIDE
PokemonTower6FHS:
	db POKEMON_TOWER_6F, POKEMONTOWER6F_RARE_CANDY, HIDE
...
WardensHouseHS:
	db WARDENS_HOUSE, WARDENSHOUSE_RARE_CANDY, HIDE
PokemonMansion1FHS:
...
FightingDojoHS:
	...
	db FIGHTING_DOJO, FIGHTINGDOJO_HITMONCHAN_POKE_BALL, HIDE
SilphCo1FHS:
...
PowerPlantHS:
	...
	db POWER_PLANT, POWERPLANT_RARE_CANDY, HIDE
	db POWER_PLANT, POWERPLANT_TM_THUNDER, HIDE
	db POWER_PLANT, POWERPLANT_TM_REFLECT, HIDE
VictoryRoad2FHS:
	db VICTORY_ROAD_2F, VICTORYROAD2F_MOLTRES,       SHOW
	db VICTORY_ROAD_2F, VICTORYROAD2F_TM_SUBMISSION, HIDE
	...
	db VICTORY_ROAD_2F, VICTORYROAD2F_BOULDER3,      HIDE
BillsHouseHS:
...
SSAnne2FRoomsHS:
	...
	db SS_ANNE_2F_ROOMS, SSANNE2FROOMS_RARE_CANDY, HIDE
SSAnneB1FRoomsHS:
	db SS_ANNE_B1F_ROOMS, SSANNEB1FROOMS_ETHER,      HIDE
	db SS_ANNE_B1F_ROOMS, SSANNEB1FROOMS_TM_REST,    HIDE
...
RocketHideoutB2FHS:
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_MOON_STONE,    HIDE
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_NUGGET,        HIDE
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_TM_HORN_DRILL, HIDE
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_SUPER_POTION,  HIDE
RocketHideoutB3FHS:
	db ROCKET_HIDEOUT_B3F, ROCKETHIDEOUTB3F_TM_DOUBLE_EDGE, HIDE
	db ROCKET_HIDEOUT_B3F, ROCKETHIDEOUTB3F_RARE_CANDY,     HIDE
RocketHideoutB4FHS:
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_GIOVANNI,      SHOW
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_HP_UP,         HIDE
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_TM_RAZOR_WIND, HIDE
...
SilphCo5FHS:
	...
	db SILPH_CO_5F, SILPHCO5F_TM_TAKE_DOWN, HIDE
...
SilphCo7FHS:
	...
	db SILPH_CO_7F, SILPHCO7F_TM_SWORDS_DANCE, HIDE
...
SilphCo10FHS:
	...
	db SILPH_CO_10F, SILPHCO10F_RARE_CANDY,     HIDE
...
PokemonMansionB1FHS:
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_RARE_CANDY,   HIDE
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_FULL_RESTORE, HIDE
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_TM_BLIZZARD,  HIDE
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_TM_SOLARBEAM, HIDE
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_SECRET_KEY,   HIDE
SafariZoneEastHS:
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_FULL_RESTORE, HIDE
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_MAX_RESTORE,  HIDE
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_CARBOS,       HIDE
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_TM_EGG_BOMB,  HIDE
SafariZoneNorthHS:
	db SAFARI_ZONE_NORTH, SAFARIZONENORTH_PROTEIN,       HIDE
	db SAFARI_ZONE_NORTH, SAFARIZONENORTH_TM_SKULL_BASH, HIDE
SafariZoneWestHS:
	db SAFARI_ZONE_WEST, SAFARIZONEWEST_MAX_POTION,     HIDE
	db SAFARI_ZONE_WEST, SAFARIZONEWEST_TM_DOUBLE_TEAM, HIDE
	db SAFARI_ZONE_WEST, SAFARIZONEWEST_MAX_REVIVE,     HIDE
	db SAFARI_ZONE_WEST, SAFARIZONEWEST_GOLD_TEETH,     SHOW
SafariZoneCenterHS:
	db SAFARI_ZONE_CENTER, SAFARIZONECENTER_NUGGET, HIDE
CeruleanCave2FHS:
	db CERULEAN_CAVE_2F, CERULEANCAVE2F_PP_UP,        HIDE
	db CERULEAN_CAVE_2F, CERULEANCAVE2F_ULTRA_BALL,   HIDE
	db CERULEAN_CAVE_2F, CERULEANCAVE2F_FULL_RESTORE, HIDE
CeruleanCaveB1FHS:
	db CERULEAN_CAVE_B1F, CERULEANCAVEB1F_MEWTWO,     SHOW
	db CERULEAN_CAVE_B1F, CERULEANCAVEB1F_ULTRA_BALL, HIDE
	db CERULEAN_CAVE_B1F, CERULEANCAVEB1F_MAX_REVIVE, HIDE
VictoryRoad1FHS:
	db VICTORY_ROAD_1F, VICTORYROAD1F_TM_SKY_ATTACK, HIDE
	db VICTORY_ROAD_1F, VICTORYROAD1F_RARE_CANDY,    HIDE
ChampionsRoomHS:
