	...
	; const_export CELADONMART3F_CLERK1
	; const_export CELADONMART3F_CLERK2
	; const_export CELADONMART3F_CLERK3
	; const_export CELADONMART3F_CLERK4
	; const_export CELADONMART3F_CLERK5
...
CeladonMart3F_Object:
	...
	def_object_events
	object_event 13,  5, SPRITE_CLERK, STAY, NONE, TEXT_CELADONMART3F_CLERK
	; object_event 15,  5, SPRITE_CLERK, STAY, NONE, TEXT_CELADONMART3F_CLERK1
	; object_event 16,  5, SPRITE_CLERK, STAY, NONE, TEXT_CELADONMART3F_CLERK2
	; object_event 17,  5, SPRITE_CLERK, STAY, NONE, TEXT_CELADONMART3F_CLERK3
	; object_event 18,  5, SPRITE_CLERK, STAY, NONE, TEXT_CELADONMART3F_CLERK4
	; object_event 19,  5, SPRITE_CLERK, STAY, NONE, TEXT_CELADONMART3F_CLERK5
