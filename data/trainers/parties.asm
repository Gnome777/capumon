...
ErikaData:
	db $FF, 26, TANGELA, 27, VILEPLUME, 27, VICTREEBEL, 0
	; Rematch
	db $FF, 63, TANGELA, 64, VILEPLUME, VICTREEBEL, 66, EXEGGUTOR, 0

KogaData:
	db $FF, 33, ARBOK, 33, GOLBAT, 34, GRIMER, 35, WEEZING, 0
	; Rematch
	db $FF, 64, GOLBAT, 66, ARBOK, 66, MUK, 67, WEEZING, 68, VENOMOTH, 0
...
Rival2Data:
; SS Anne 2F
	db $FF, 23, GLOOM, 23, MANKEY, 23, DIGLETT, 23, PIDGEOTTO, 24, WARTORTLE, 0
	db $FF, 23, FEAROW, 23, MANKEY, 23, DIGLETT, 23, SLOWPOKE, 24, IVYSAUR, 0
	db $FF, 23, WEEPINBELL, 23, MANKEY, 23, DIGLETT, 23, GYARADOS, 24, CHARMELEON, 0
; Pokémon Tower 2F
	db $FF, 28, GLOOM, 28, HAUNTER, 28, KADABRA, 28, PIDGEOTTO, 29, WARTORTLE, 0
	db $FF, 28, FEAROW, 28, HAUNTER, 28, KADABRA, 28, SLOWPOKE, 29, IVYSAUR, 0
	db $FF, 28, WEEPINBELL, 28, HAUNTER, 28, KADABRA, 28, GYARADOS, 29, CHARMELEON, 0
; Silph Co. 7F
